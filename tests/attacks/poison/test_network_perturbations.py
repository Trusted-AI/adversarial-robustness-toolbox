...
def test_100_percent(sample_array):
    result = flip_target_label(sample_array, flip_target=1, poison_percentage=1.0)
...
def test_0_percent(sample_array):
    result = flip_target_label(sample_array, flip_target=1, poison_percentage=0.0)
...
def test_bool_array(sample_array):
    ...
    result = flip_target_label(bool_array, flip_target=1, poison_percentage=0.5)
...
def test_empty_array():
    ...
    result = flip_target_label(empty_array, flip_target=1, poison_percentage=0.5)
