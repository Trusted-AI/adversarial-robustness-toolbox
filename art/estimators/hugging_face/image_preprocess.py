...
from .base_image_preprocessor import resize, rescale, normalize
import torchvision
import torch
import numpy as np
...
class ARTViTImageProcessor(BaseImageProcessor):
    r"""
    ...
    def rescale(
        self, image: np.ndarray, scale: float, data_format: Optional[str] = None, **kwargs
    ) -> np.ndarray:
        """
