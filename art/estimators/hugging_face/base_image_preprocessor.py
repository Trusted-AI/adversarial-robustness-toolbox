...
def resize(
    ...
    import torchvision
    resample = resample if resample is not None else torchvision.transforms.InterpolationMode.BILINEAR
    ...
    resized_image = torchvision.transforms.functional.resize(image,
                                                             size=(width, height),
