...
RUN pip3 install matplotlib==3.2.1 numpy==1.18.1 scipy==1.4.1 six==1.13.0 Pillow==7.0.0 scikit-learn==0.22.1
RUN pip3 install lightgbm==2.3.1 pytest-pep8==1.0.6 codecov==2.0.22 h5py==2.10.0 requests==2.23.0
RUN pip3 install statsmodels==0.11.0  cma==2.7.0 pydub==0.23.1 resampy==0.2.2
